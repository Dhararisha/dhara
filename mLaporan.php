...
class mLaporan extends CI_Model
{
    ...
    public function pengaduan()
    {
        ...
        $this->db->join('monitoring', 'monitoring.id_monitoring = pengaduan.id_monitoring', 'left');
        $this->db->join('asset_kep', 'asset_kep.id_pengaduan = pengaduan.id_pengaduan', 'left');
