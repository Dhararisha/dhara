                    ...
                    <div class="card card-danger">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="no" value="<?= $asset->no_asset ?>" class="form-control" id="exampleInputPassword1" placeholder="No Asset">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id" value="<?= $asset->id_user ?>" class="form-control" id="exampleInputPassword1" placeholder="Id User">
