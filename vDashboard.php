            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Pengaduan Diterima</span>
                            <span class="info-box-number"> <?= $jml['pengaduan']->jml_pengaduan ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer clearfix">
                            <a href="<?= base_url('Timti/cKeputusan') ?>" class="btn btn-sm btn-info float-left">Lihat Keputusan Pengaduan</a>
                        </div>
                        <!-- /.card-footer -->
                    </div>
                    <!-- /.card -->
