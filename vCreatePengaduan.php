        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-outline card-info">
                    ...
                    <!-- /.card-header -->
                    <?php echo form_open_multipart('admin/cpengaduan/create'); ?>
            ...
            <div class="col-md-6">
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">
                            Pengaduan Data
                            <small>Masukkan Data Pengaduan</small>
                        </h3>
                        <!-- tools box -->
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool btn-sm" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                    ...
                    <div class="card-body pad">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="jml" class="form-control" placeholder="Jumlah Pengaduan">
